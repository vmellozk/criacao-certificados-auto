...
def gerar_certificados(planilha_path, imagem_certificado):
    nomes_processados = []
    ...
    try:
        ...
        for indice, coluna in enumerate(pag_planilha.iter_rows(min_row=2)):
            ...
            if nome in nomes_processados:
                print(f"Erro na linha {indice + 1}: o nome já foi processado.")
                continue
            ...
            #Abrindo Imagem
            imagem = Image.open(imagem_certificado)
...
gerar_certificados(r'D:\Python(Emissão_Certificados)\planilha_alunos.xlsx', r'D:\Python(Emissão_Certificados)\certificado_padrao.jpg')
